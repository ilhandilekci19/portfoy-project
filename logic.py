...
if __name__ == '__main__':
    ...
    manager.insert_project([(1,"Discord Bot","www","aciklama",manager.get_status_id("Prototip Oluşturma")),(1,"Saat_belirleyici","www","aciklama",manager.get_status_id("Güncellendi"))])
    manager.insert_skill(1,"Discord Bot","Python")
    manager.insert_skill(1,"Saat_belirleyici","API")
    manager.insert_skill(1,"Saat_belirleyici","Python")
    manager.insert_skill(1,"Discord Bot","API")

    info=manager.get_project_info(1,"Discord Bot")
    print("Proje Bilgisi:",info)
    skills=manager.get_project_skills("Saat_belirleyici")
    print("Kullanılan yetenekler",skills)